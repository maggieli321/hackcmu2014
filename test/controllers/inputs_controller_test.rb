...
class InputsControllerTest < ActionController::TestCase
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post :create, input: { date: @input.date, exp_date: @input.exp_date, food_id: @input.food_id, name: @input.name, num_days: @input.num_days, quality: @input.quality, user_id: @input.user_id }
    end
  ...
  test "should update input" do
    patch :update, id: @input, input: { date: @input.date, exp_date: @input.exp_date, food_id: @input.food_id, name: @input.name, num_days: @input.num_days, quality: @input.quality, user_id: @input.user_id }
    assert_redirected_to input_path(assigns(:input))
  end
